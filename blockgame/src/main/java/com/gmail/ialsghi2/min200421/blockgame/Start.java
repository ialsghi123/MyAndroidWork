package com.gmail.ialsghi2.min200421.blockgame;
...
public class Start extends AppCompatActivity implements View.OnClickListener {
    ...
    ImageView[] iv=new ImageView[8]; //iv[0] <--?초기값 null
    ...
    public void onClick(View v) {
        ...
        switch (imageView.getId()){
            //맨 아래 블럭 iv[7] ImageView의 색상과일치하는 버튼인지 판정
        ...
        if(isOk) { //버튼 색깔을 맞추었다면!
            ...
            for(int i=iv.length-2; i>=0; i--){
                ...
                iv[i+1].setTag(num+""); //i아래쪽 블럭 tag값 업데이트
            }//end for
