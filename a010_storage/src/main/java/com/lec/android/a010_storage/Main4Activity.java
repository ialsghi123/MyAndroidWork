...
public class Main4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            e.printStackTrace();;
            Log.e("myapp","데이터 베이스를 열 수 없음"); //Logcat의 error에 표시됨
    ...
    void insert(String name,int age,String address){
        ...
        //INSERT INTO tableName (name,age,addrss) values(?,?,?)
...
//                           --> WHERE owner='Mike'
    ...
    void update(String name,int age,String address){
        ...
        values.put("age",age); //변경할값
        values.put("address",address); //변경할값


        //UPDAE student SET age = ?, address = ? WHERE name = ?
        //리턴값은 affected row
        ...
        String msg = String.format("%d개의 row update 성공",cnt);
        tvResult.setText(msg);
        select();

    }

    //특정 name 값을 가진 레코드를 삭제
