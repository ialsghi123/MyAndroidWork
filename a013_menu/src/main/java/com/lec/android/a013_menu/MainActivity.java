...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        Log.d("myapp","onCreateOptionsMenu - 최초 메뉴키가 눌렸을때 호출됨");
        ...
        return true; //false 리턴하면 메뉴는 보여지지않는다
    }
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        Log.d("myapp","onPrepareOptionsMenu - 옵션 메뉴가 화면에 보여질때 마다 호출됨");
        ...
        return super.onPrepareOptionsMenu(menu); // false리턴하면 메뉴 보여지지 않음
    }
